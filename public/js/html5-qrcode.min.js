  ...
  function o(t) {
    (this.image = t),
      ...
      (this.sizeOfBlackWhiteBlackRun = function (e, t, n, r) {
        ...
        for (
          ...
          var c = i ? l : d,
            g = i ? d : l;
          if (
            (1 == u ? this.image[c + g * A.width] && u++ : this.image[c + g * A.width] || u++,
            3 == u)
          ) {
            var v = d - e,
              m = l - t;
      ...
      (this.computeDimension = function (e, t, n, r) {
        var i =
          7 + ((Math.round(this.distance(e, t) / r) + Math.round(this.distance(e, n) / r)) >> 1);
        switch (3 & i) {
          case 0:
            i++;
            break;
      ...
      (this.findErrorMagnitudes = function (e, t, n) {
        for (var r = t.length, i = new Array(r), a = 0; a < r; a++) {
          for (var o = this.field.inverse(t[a]), s = 1, h = 0; h < r; h++)
            a != h &&
              (s = this.field.multiply(s, _.addOrSubtract(1, this.field.multiply(t[h], o))));
  ...
  (A.imagedata = null),
    ...
    (A.setWebcam = function (e) {
      ...
      t.getUserMedia
        ...
        : t.mozGetUserMedia &&
          ((A.moz = !0), t.mozGetUserMedia({ video: n, audio: !1 }, A.vidSuccess, A.vidError));
    }),
    (A.decode = function (e) {
    ...
    (A.getPixel = function (e, t) {
      ...
      return (
        (33 * A.imagedata.data[n] + 34 * A.imagedata.data[n + 1] + 33 * A.imagedata.data[n + 2]) /
        100
      );
    }),
    ...
    (A.getMiddleBrightnessPerArea = function (e) {
      for (
        var t = Math.floor(A.width / 4), n = Math.floor(A.height / 4), r = new Array(4), i = 0;
        i < 4;
        i++
      ) {
        r[i] = new Array(4);
  ...
  function D() {
    (this.image = null),
      ...
      (this.handlePossibleCenter = function (e, t, n) {
        ...
        if (
          !isNaN(a) &&
          ((i = this.crossCheckHorizontal(Math.floor(i), Math.floor(a), e[2], r)), !isNaN(i))
        ) {
      ...
      (this.findRowSkip = function () {
        ...
        for (var t = null, n = 0; n < e; n++) {
          ...
          if (r.Count >= B) {
            if (null != t)
              return (
                (this.hasSkipped = !0), Math.floor((Math.abs(t.X - r.X) - Math.abs(t.Y - r.Y)) / 2)
              );
            t = r;
          }
        }
        ...
        if (e < this.bitPointer + 1 + 16) {
          ...
          return (
            ...
            (t =
              o +
              s +
              ((this.blocks[this.blockPointer] & a) >> (8 - (e - (this.bitPointer + 1 + 8))))),
